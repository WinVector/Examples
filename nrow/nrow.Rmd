...
there are other reasons table might have `R` `raw` columns in them, so we should expect our
...
In fact we start to feel trapped here.  For a data-object who's only column is of type `raw` we

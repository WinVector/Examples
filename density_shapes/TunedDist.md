...
The above lack of symmetiry means we probably have a different single
parameter family of ROC curves for each prevelance, as the 0.5
...
single parameter of this nature, then using a signle derived parameter

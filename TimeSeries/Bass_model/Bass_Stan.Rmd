...
plot_Bass_curve <- function(values, n_pad, p, q, m) {
  ...
  return( list(predictions = as.numeric(pred), i_max = i_max - best_shift) )
}
```
...
# d_predict <- lapply(
#   seq(as.Date('2018-01-01'), as.Date('2025-01-01'), by = '3 months'),
#   fit_pred_given_train_date)
```

...
All of the above is an expansion of saying: "given the `pdq(2, 0, 2)` specification and <code>y, x, z</code>, the modeling system then fits for <code>&phi;, &beta;, &theta;, &epsilon;</code> (with <code>&epsilon;</code> small norm)."

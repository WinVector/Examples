...
where <code>B</code> is the shift operator such that <code>B u<sub>t</sub> = u<sub>t-1</sub></code>, and <code>c = mean(1 - &phi;<sub>1</sub> - ... - &phi;<sub>p</sub>)</code>. We solve for <code>&epsilon;<sub>t</sub></code> being small. We very much prefer calling the <code>&epsilon;<sub>t</sub></code> "the external shocks", and not calling them "errors."

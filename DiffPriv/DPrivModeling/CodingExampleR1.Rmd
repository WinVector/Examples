...
runBigExpmt <- function(expmt) {
  ...
  dTrainB$pred <- preds$trainPred
  print(paste(eName,
              'Laplace noised',bSigmaBest,'train rmse',
              rmse(dTrainB$pred,dTrainB[[yName]])))
  print(WVPlots::ScatterHist(dTrainB,'pred',yName,
                             paste(eName,
  ...
  dTestB$pred <- preds$appPred
  print(paste(eName,
              'Laplace noised',bSigmaBest,'test rmse',
              rmse(dTestB$pred,dTestB[[yName]])))
  print(WVPlots::ScatterHist(dTestB,'pred',yName,
                             paste(eName,
...
runBigExpmt(list(vplan=vplan1,fnFitter=lrFitter,
...
runBigExpmt(list(vplan=vplan2,fnFitter=lrFitter,
...
runBigExpmt(list(vplan=vplan2,fnFitter=dFitter,

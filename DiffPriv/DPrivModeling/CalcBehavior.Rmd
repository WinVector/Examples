...
plotDv1 <- evalModelingStrategy(d,dTest,signalValues,noiseGroups,
                                noisedModelFixedV1,nPlans,
                                paste('Laplace noise averaged frame (sigma=',sigma,') prediction',
                                      sep=''),
                                parallelCluster,commonFns)$plotD

# average prediction accross re-runs
plotDv2 <- evalModelingStrategy(d,dTest,signalValues,noiseGroups,
                                noisedModelFixedV2,nPlans,
                                paste('Laplace noise averaged prediction (sigma=',sigma,') prediction',
                                      sep=''),
                                parallelCluster,commonFns)$plotD
...
```{r plot}
# show performance
plotDAll <- rbind(plotD2,plotD3,plotD4,plotDv2)
...
# by most of the individual models
...
# show average in relation to others
plotDAll <- rbind(laPlotFrame,plotDv1,plotDv2)
ggplot(data=plotDAll,mapping=aes(x=x,
                                 y=expectedDeviance,
                                 color=what,fill=what)) +
  geom_line(size=2) +

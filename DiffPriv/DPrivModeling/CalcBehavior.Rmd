...
plotDv1 <- evalModelingStrategy(d,dTest,signalValues,noiseGroups,
                                ...
                                paste('Noised averaged frame (sigma=',sigma,') prediction',
                                      sep=''),
                                parallelCluster,commonFns)$plotD
...
plotDv2 <- evalModelingStrategy(d,dTest,signalValues,noiseGroups,
                                ...
                                paste('Noised averaged prediction (sigma=',sigma,') prediction',
                                      sep=''),
                                parallelCluster,commonFns)$plotD

# plotD5 <-  evalModelingStrategy(d,dTest,signalValues,noiseGroups,
#                                 noisedModel,sigma,
#                                 paste('varying noise (sigma=',sigma,') prediction',sep=''),
#                                 parallelCluster,commonFns)$plotD
...
laPlotFrame$what <- 'mean noised model'
ggplot() +
...
# show performance of mean-of noised models, note this isn't achieved 

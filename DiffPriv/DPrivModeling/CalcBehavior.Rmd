...
# could in theory anneal the detailed noise parameters directly
bestArea <- 0
bestSigma <- 0
plotDS <- c()
for(sigma in 1:5) {
  noisePlan <- mkNoisePlanConst(d,unique(c('group',noiseGroups)),sigma)
...
plotDAll <- rbind(plotD2,plotD3,plotD4,plotDS)

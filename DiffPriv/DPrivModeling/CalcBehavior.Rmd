...
mkNoisedModel <- function(sigma) {
  force(sigma)
  function(d,vars,dTest) {
    coder <- trainBayesCoder(d,'y',vars,3)
...
ggplot(data=plotDAll,mapping=aes(x=x,
  ...
  geom_line() +
  ggtitle(paste('expected test deviance as a function of signal strength x,\n n=',n))
```

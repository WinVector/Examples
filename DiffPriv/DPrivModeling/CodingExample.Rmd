...
dTrainV <- vtreat::prepare(treatments,dTrain,pruneSig=0.2,
                           parallelCluster=cl)
dTestV <- vtreat::prepare(treatments,dTest,pruneSig=0.2,
                          parallelCluster=cl)
...
treatments <- vtreat::designTreatmentsC(dTrainC,vars,yName,TRUE,
                                        ...
                                        parallelCluster=cl)
#print(treatments$scoreFrame)
dTrainV <- vtreat::prepare(treatments,dTrainT,pruneSig=0.2,
                           parallelCluster=cl)
dTestV <- vtreat::prepare(treatments,dTest,pruneSig=0.2,
                          parallelCluster=cl)
varsV <- setdiff(colnames(dTrainV),yName)
...
varsV <- treatments$scoreFrame$varName[treatments$scoreFrame$csig<0.2]

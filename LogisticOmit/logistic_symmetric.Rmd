...
Without the extra variable `omitted` we can't tell the joined pairs apart, and we are forced to use compromise effect estimates. Or we can't tell that the ommited variable has already eliminated a lot of the probability uncertainty before we try to fit.

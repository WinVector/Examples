...
A possible source of surprise is: appealing to assumed independence is a common way of assuring one is avoiding issues such as [Simpson's paradox](https://en.wikipedia.org/wiki/Simpson%27s_paradox) in linear regression modeling. Thus it is possible an "independence implies non-interference" intuition is part of some modeler's toolboxes.
...
What are your opinions/experience? Some questions I feel are relevant include:
  ...
  * What is the correct value of the `x`-coefficient? in the logistic regressions? `3.1415` or `1.8522`?

...
The maximum entropy principle in machine learning can be thought of as aspiring to the role the [stationary-action principle action](https://en.wikipedia.org/wiki/Stationary-action_principle) plays in classic mechanics. And, [maximum entropy modeling is very related to logistic regresion modeling](https://win-vector.com/2011/09/23/the-equivalence-of-logistic-regression-and-maximum-entropy-models/). The germinal reference on this remains, in my opinion, Cover and Thomas, "Elements of Information Theory".

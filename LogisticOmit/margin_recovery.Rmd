...
Some calculus will show us in our case the entropy is maximized where the gradient is zero. For our example this gradient being zero is the same condition as our distribution being orthogonal to `ns`. So the maximum entropy condition is enforcing the "no interactions" invariant we commented on earlier.

...
Some calculus (not shown) can prove that the entropy function for this problem is maximized where the joint distribution is orthogonal to `ns` or `test_vec`. So the maximum entropy condition will enforce the "no interaction" invariant we commented on earlier.

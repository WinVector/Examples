...
(Thank you, Tom Palmer and Bob Horton for references!)
...
The above margin frame describes how the detailed experiment is marginalized or censored down to what different experimenters that have access to only some of the explanatory variables see. Experimenter 1 sees oly the first four rows, and experimenter 2 sees only the next 4 rows. 

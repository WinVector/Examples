...
The recovered `maxent_dist` obeys the "no interaction" check. The maximum entropy condition pushed us to this check.
...
In fact, the recovered `maxent_dist` *is* the original unobserved original `proportion`.

...
```
    ...
    ## # Source:   table<sparklyr_tmp_13ade5b174e30> [?? x 2]
    ## # Database: spark_connection
    ##       x     y
    ##   <int> <chr>
    ## 1     1     a
...
```
    ...
    ## # Source:   table<sparklyr_tmp_13ade7441a4ba> [?? x 11]
    ## # Database: spark_connection
    ##     mpg   cyl  disp    hp  drat    wt  qsec    vs    am  gear  carb
    ##   <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
...
```
    ...
    ## # Source:   table<sparklyr_tmp_13ade23a0a3c4> [?? x 11]
    ## # Database: spark_connection
    ##     mpg   cyl  disp    hp  drat    wt  qsec    vs    am  gear  carb
    ##   <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
    ## 1  21.0     6 160.0   110  3.90 2.620 16.46     0     1     4     4
...
```
    ...
    ## [1] "JOINTMP_tN6sKWqKN6nar6OglLpc_0000000000"
    ## [2] "JOINTMP_tN6sKWqKN6nar6OglLpc_0000000001"
    ## [3] "JOINTMP_tN6sKWqKN6nar6OglLpc_0000000002"
...
```
    ...
    ## 1     1   0.3452169  0.97875773 0.006562022   0.9294422   0.4180307
    ## 2     2   0.9407381  0.81922898 0.577899282   0.7212242   0.8844907
    ## 3     3   0.5486146  0.07701584 0.356456231   0.5243967   0.3068922
...
```
    ...
    ## Ncells  832896 44.5    1442291 77.1  1442291 77.1
    ## Vcells 1558162 11.9    2552219 19.5  2049695 15.7

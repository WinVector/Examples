...
Rember each outcome we are trying to match  is `0` or `1` (and each row in the data set can represent multiple individuals).
...
Don't bother learning the ROC plot until you are comfotable with sensitivity and specificity. All the information in the ROC plot is also in this easy to read plot.
...
## Summary
  ...
  * In either case, the fears of the practitioner don't always match the fears of the theorist.

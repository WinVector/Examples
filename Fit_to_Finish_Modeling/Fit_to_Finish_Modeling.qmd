...
Statisticians are fond of observing "terms are used differently in data science" (code for not reading in other fields).

I will show what it looks like to rush from data to building a model predictive model (supervised machine learning).
Also I will demonstrate working fast in idiomatic R.

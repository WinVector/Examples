...
Each entry of `pairs` is the edge-set of a graph where `pred1` and `pred2` orders disagree. The components of this graph are bipartite, and we want new variables eliminate edges from these graphs.

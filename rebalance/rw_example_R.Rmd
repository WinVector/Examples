...
In our case the supports of the bipartite components are `{({1,2}, {4, 5, 6}), ({3}, {7})}`. Our idea is to introduce variables that identify these support sets, as this would give the model the degrees of freedom needed to re-score these sets independtly and remove the compromises forcing the non-monotone change.
...
TODO: mention how fitting with a different prevalance or replacing out priors both don't give the balance conditions of a standard logistic regression.

...
One thing we have shown: even for logistic regression there are situations where the model homotopy bundle is *not* of the form `f(m(X), p)` where `f()` is a monotone function of the original model prediction `m(X)` and a new assumed prevalance `p`.

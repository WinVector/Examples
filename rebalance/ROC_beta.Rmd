...
This quick note is an aside related to [The Typical Shape of the ROC plot](https://github.com/WinVector/Examples/blob/main/rebalance/ROC_shape.md).
...
There may be plotting artifacts as the two curves are parameterized at much different rates. So at some places we are comparing one curve to the linear interpolation of the other.